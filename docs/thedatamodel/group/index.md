...
Required data attributes are indicated bold in the table below: 
* By clicking on the blue table title -> all data attributes become visable, 
* By clicking on the data entity buttons -> all data attributes become visable of that data entity ans.

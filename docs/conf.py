...
project = 'Farm Level Data Standard (Initial drafts)'
copyright = ''
author = 'Data Impact'
...
latex_documents = [
    (master_doc, 'sphinx.tex', 'Farm Level Data Standard',
     'Farm Level Data Standard', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx', 'Farm Level Data Standard (Draft)',
     [author], 1)
]

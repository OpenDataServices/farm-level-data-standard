...
create_template(schema="first-mile-farm-data-marsadoptionobservations-schema.json",output_name="../csv",output_format='csv')


print("Full schema in first-mile-farm-data-marsadoptionobservations-schema updated")
